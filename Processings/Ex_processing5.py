...
if __name__ == '__main__':
    ...
    # file_list = list(filter(os.path.isdir, os.listdir(file_path)))
    # max_depth = 0
    #
    # print(file_list)
    ...
    #
    #
    # with open('D:/vhit/ahn ,hyo joon_200555967/Result_Ex_processing5.tsv', 'w', encoding='UTF-8', newline='') as f:
